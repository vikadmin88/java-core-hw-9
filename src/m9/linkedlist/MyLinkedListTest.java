...
public class MyLinkedListTest {
    public static void main(String[] args) {
        ...
        strMyLinkedList.remove(0);
        strMyLinkedList.remove(3);
        strMyLinkedList.remove(5);
        System.out.printf("strMyLinkedList = %s Size: %d\n", strMyLinkedList, strMyLinkedList.size());
        System.out.println();
        intMyLinkedList.remove(0);
        intMyLinkedList.remove(3);
        intMyLinkedList.remove(5);
        System.out.printf("intMyLinkedList = %s Size: %d\n", intMyLinkedList, intMyLinkedList.size());
        System.out.println();
